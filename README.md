...
- [x] Explain what a token is used for.
        A token is a string that the servver provides any app that logs into it so that the app can provide it as proof of logging in. 
- [x] What steps can you take in your web apps to keep your data secure?
        Put sensitive or personal information behing private routes and require a token to access them. Should also use a library to dynamically generate the token. 
- [x] Describe how web servers work.
        A web stores information and listens for input from an app. The server has different protocols to follow depending on the type of information the app requests. 
...
Project URL : https://github.com/Michael-Bailar/react-bubbles 